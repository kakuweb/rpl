...
export const people: Person[] = [
  ...
  },
  {
    ...
    role_group: "visitors",
    bio: "Flexible and stretchable electronics: printed circuits and deformable sensors for bioelectronics and soft robotics. Researcher in the Fukuda Research Group at Osaka University. At the lab from 24 August to 28 September 2026.",
    photo_url: null,
    photo_label: "Portrait photo",
    profile_url: null,
    sort_order: 110,
  ...
  {
    id: "shinnoyo-yamada",
    slug: "shinnoyo-yamada",
    name: "Shinnoyo Yamada",
    role: "Visiting Researcher",
    role_group: "visitors",
    bio: "Visiting from Waseda University, from 1 September to 29 November 2026.",
    photo_url: null,
    photo_label: "Portrait photo",
    profile_url: null,
    sort_order: 120,
